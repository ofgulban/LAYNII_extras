...
# FILE1 = "/home/faruk/gdrive/LAYNII/demo_big3/M_brain_simulated_layers_noised.nii.gz"
FILE1 = "/home/faruk/gdrive/LAYNII/demo_big3/M_brain_draining_veins_noised.nii.gz"
...
for j in idx_columns:
    ...
    ax1.scatter(norm_depth_roi, data_roi, c="black", alpha=0.1, marker=".")
    ax1.set_xlim((0, 1))
    ...
    ax2.plot(idx_layers, layer_bins[1:], c="black", linewidth=0.5)
